function matrixToDataURL(matrix) {
  ...
  for (let i = 0; i < matrix.length; i++) {
    for (let j = 0; j < matrix[i].length; j++) {
      ...
      const value = matrix[i][j] * 255; // Multiply by 255 to convert 1 to 255 (black) and 0 to 0 (white)
      
      imageData.data[pixelIndex] = 255 - value; // Invert the value to get the correct color
